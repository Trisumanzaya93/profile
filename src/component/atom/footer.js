...
function Footer() {
  return (
    <div className='border-t-[1px] border-[#232946] mt-auto  pb-2 pt-2 flex justify-between'>
        <h1 className='font-primary text-sm font-bold mx-10 '>&copy; 2023, Tri Sumanzaya</h1>
        <div className=' w-36 flex justify-between mr-10'>
            <button className='active:scale-110' onClick={()=>window.open("https://www.instagram.com/trisumanzaya/")}>
            ...
            <button className='active:scale-110' onClick={()=>window.open("https://www.linkedin.com/in/trisumanzaya/")}>
            ...
            <button className='active:scale-110' onClick={()=>window.open("https://github.com/Trisumanzaya93")}>
