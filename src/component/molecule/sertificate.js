...
function Sertificate() {
  return (
    <div className="w-full">
      <div>
      <div className="w-max px-5 mb-5 py-2 rounded-br-xl rounded-tr-xl border-2 shadow-lg border-[#232946]">
        <h1 className=" text-3xl">Fazztrack</h1>
        </div>
      ...
      <div className="mt-10">
        <div className="w-max px-5 mb-5 py-2 rounded-br-xl rounded-tr-xl border-2 shadow-lg border-[#232946]">
        <h1 className=" text-3xl">Dicoding</h1>
        </div>
