...
const Snake = (props) => {
    ...
    return (
        <div>
        <div className="snake-container flex justify-center" id="snake-container">
            <div   
             ...
             <div 
                ...
                >
                <div 
                    className="point-bar mb-10"
                    style={{width: dim}}
                    >
                        <div style={{color: props.color1}} className='text-4xl font-primary'>Score: {points}</div>
                </div>
                <div>
                    <button
                        onClick={() => turn('up', 'down')}
                        className=' bg-[#232946] text-gray-100 text-2xl py-1 px-5 rounded-lg'
                        >&#8593;</button>
                </div>
                <div>
                    <button
